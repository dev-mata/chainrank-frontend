        ...
        <div className="h-screen bg-[#E31950] flex items-center justify-center px-4">
            <div className="w-full max-w-md">
                ...
                <div className='flex flex-col items-center justify-center text-center mb-8'>
                    ...
                    <div className='font-rhm mt-2 text-gray-100'>Welcome back! You have been missed</div>
                ...
                <form className="space-y-3">
                    ...
                    <div>
                        ...
                        <div className="flex justify-end items-center">
                            ...
                            <a href="#" className="text-sm text-gray-100 hover:text-black mt-2 font-rhm justify-end">
